...
class Ingredient extends BaseModel {
    ...
    public function save() {
        ...
        $query = DB::connection()->prepare(
                ...
                . 'recipe_id, food_id, volume, unit, added, updated)'
                . 'VALUES (:recipe_id, :food_id, :volume, :unit, CURRENT_DATE,'
    ...
    public function validate_unit() {
        ...
        if (!$this->unit == 'kilogrammaa' || !$this->unit == 'litraa' ||
                !$this->unit == 'kappaletta') {
            $errors[] = 'Väärä yksikkö "' . $this->unit .
                    '"! Käytä yksikkönä joko kilogrammaa,'
                    . ' litraa tai kappaletta.';
        }
